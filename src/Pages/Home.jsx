...
const SOCIAL_LINKS = [
  ...
  { icon: Kaggle, link: "https://www.kaggle.com/negi108333" },
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      ...
      >
        <div className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-24 min-h-screen flex items-center">
          <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-8 lg:gap-16">
            {/* Left Column */}
            <div
              className="w-full lg:w-1/2 space-y-6 text-center lg:text-left pl-0 lg:pl-4"
              data-aos="fade-right"
              data-aos-delay="200"
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Learning and growing in the field of Computer Applications, with hands-on projects in AI, ML, and modern web technologies
                </p>
