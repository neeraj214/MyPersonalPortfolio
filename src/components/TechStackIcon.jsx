...
const TechStackIcon = ({ TechStackIcon, Language }) => {
  return (
    <div className="group w-full h-full min-h-[180px] md:min-h-[200px] p-6 md:p-7 rounded-2xl bg-slate-800/50 hover:bg-slate-700/50 transition-all duration-300 ease-in-out flex flex-col items-center justify-center gap-3 hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl">
